...
STATE_FILE = r'C:/Users/metet/Desktop/aws-version/kafka/log-analyzer-new/state.json'
TIME_REPORT_FILE = r'C:/Users/metet/Desktop/aws-version/kafka/log-analyzer-new/time_report.csv'
...
def analyze_logs_to_csv(input_file, output_file):
    ...
    try:
        ...
        pass # Silently drop error to prevent terminal spam

if __name__ == "__main__":
    analyze_logs_to_csv('C:\\Users\\metet\\Desktop\\aws-version\\kafka\\kafkaConsumer-new\\logs\\email-consumer.log',
                        'C:\\Users\\metet\\Desktop\\aws-version\\kafka\\log-analyzer-new\\log_report_kafka.csv')